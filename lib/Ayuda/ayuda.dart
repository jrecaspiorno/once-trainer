      ...
      body: Container(
        ...
        child: ListView(
          ...
          children:  <Widget>[
            ...
            Text( '4. Historial Actividades: Se muestra la información de la actividad fisica registrada por la aplicación.\n', style: TextStyle(fontSize: 17)),
            Text(  '5. Historial clínico: Hay disponible información sobre el peso, el ritmo cardiaco y las energías quemadas. La información se mostrará en forma de gráfica y escrita para que sea accesible para el usuario.\n', style: TextStyle(fontSize: 17)),
            ...
            Text(  '7. Lista de ejercicios: En esta ventana se encuentran todos los ejercicios de la aplicación. Si el usuario entra en un ejercicio podrá realizarlo y cuando terminé pulsará el botón de hecho.\n', style: TextStyle(fontSize: 17)),
            ...
            Text( '9. Alerta ritmo cardiaco: Al realizar cualquier ejercicio si el usuario supera su frecuencia máxima cardiaca saltará una alerta, tanto visual como sonora, para que el usuario reduzca la actividad física.\n', style: TextStyle(fontSize: 17)),
          ]
        ),
      )
    );
